...
class Restaurant(Base):
    ...
    loading_video_url: Mapped[str] = mapped_column(String(500), default="")
    loading_video_filename: Mapped[str] = mapped_column(String(255), default="")
    loading_video_size_bytes: Mapped[int] = mapped_column(Integer, default=0)
