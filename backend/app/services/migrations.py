...
def upgrade_existing_database() -> None:
    ...
    statements = [
        ...
        "ALTER TABLE restaurants ADD COLUMN IF NOT EXISTS reservations_enabled BOOLEAN NOT NULL DEFAULT TRUE",
        ...
        "ALTER TABLE restaurants ADD COLUMN IF NOT EXISTS chatbot_enabled BOOLEAN NOT NULL DEFAULT TRUE",
        "ALTER TABLE restaurants ADD COLUMN IF NOT EXISTS ai_name VARCHAR(120) NOT NULL DEFAULT ''",
        "ALTER TABLE restaurants ADD COLUMN IF NOT EXISTS ai_welcome_message TEXT NOT NULL DEFAULT ''",
        "ALTER TABLE restaurants ADD COLUMN IF NOT EXISTS ai_tone VARCHAR(120) NOT NULL DEFAULT ''",
        "ALTER TABLE restaurants ADD COLUMN IF NOT EXISTS ai_allowed_topics TEXT NOT NULL DEFAULT ''",
        "ALTER TABLE restaurants ADD COLUMN IF NOT EXISTS ai_fallback_message TEXT NOT NULL DEFAULT ''",
        "ALTER TABLE restaurants ADD COLUMN IF NOT EXISTS ai_escalation_message TEXT NOT NULL DEFAULT ''",
        "ALTER TABLE restaurants ADD COLUMN IF NOT EXISTS ai_language VARCHAR(80) NOT NULL DEFAULT ''",
